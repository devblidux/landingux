...
export const STORY_SECTIONS = [
  ...
  { id: 'section-new-workflow', nextPreview: 'UX → Product Design' },
  { id: 'section-role-evolution', nextPreview: 'Ejemplos de nuestra metodología' },
  { id: 'section-methodology-examples', nextPreview: 'Recursos del equipo' },
